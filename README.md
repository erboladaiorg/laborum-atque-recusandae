# @erboladaiorg/laborum-atque-recusandae

[![github actions][actions-image]][actions-url]
[![travis-ci](https://travis-ci.org/import-js/@erboladaiorg/laborum-atque-recusandae.svg?branch=main)](https://travis-ci.org/import-js/@erboladaiorg/laborum-atque-recusandae)
[![coverage][codecov-image]][codecov-url]
[![win32 build status](https://ci.appveyor.com/api/projects/status/3mw2fifalmjlqf56/branch/main?svg=true)](https://ci.appveyor.com/project/import-js/@erboladaiorg/laborum-atque-recusandae/branch/main)
[![npm](https://img.shields.io/npm/v/@erboladaiorg/laborum-atque-recusandae.svg)](https://www.npmjs.com/package/@erboladaiorg/laborum-atque-recusandae)
[![npm downloads](https://img.shields.io/npm/dt/@erboladaiorg/laborum-atque-recusandae.svg?maxAge=2592000)](https://www.npmtrends.com/@erboladaiorg/laborum-atque-recusandae)
...
## `@erboladaiorg/laborum-atque-recusandae` for enterprise

Available as part of the Tidelift Subscription.

The maintainers of `@erboladaiorg/laborum-atque-recusandae` and thousands of other packages are working with Tidelift to deliver commercial support and maintenance for the open source dependencies you use to build your applications. Save time, reduce risk, and improve code health, while paying the maintainers of the exact dependencies you use. [Learn more.](https://tidelift.com/subscription/pkg/npm-@erboladaiorg/laborum-atque-recusandae?utm_source=npm-@erboladaiorg/laborum-atque-recusandae&utm_medium=referral&utm_campaign=enterprise&utm_term=repo)

## Installation

```sh
# inside your project's working tree
npm install @erboladaiorg/laborum-atque-recusandae --save-dev
```
...
resolvers are just npm packages, so [third party packages are supported](https://github.com/erboladaiorg/laborum-atque-recusandae/wiki/Resolvers) (and encouraged!).
...
[codecov-image]: https://codecov.io/gh/import-js/@erboladaiorg/laborum-atque-recusandae/branch/main/graphs/badge.svg
[codecov-url]: https://app.codecov.io/gh/import-js/@erboladaiorg/laborum-atque-recusandae/
[actions-image]: https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/import-js/@erboladaiorg/laborum-atque-recusandae
[actions-url]: https://github.com/erboladaiorg/laborum-atque-recusandae
